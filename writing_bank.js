...
const WBANK_BS = [
 ...
 { id:3,  diff:"easy", context:"Where does your brother work?", chunks:["My brother","works","at","a","hospital","downtown."], extra:"working" },
 { id:4,  diff:"easy", context:"When do you usually eat dinner?", chunks:["We","usually","eat","dinner","at","seven o'clock."], extra:"eats" },
 { id:5,  diff:"easy", context:"When is the library closed?", chunks:["The library","is","closed","on","national","holidays."], extra:"close" },
 { id:6,  diff:"easy", context:"What are they planning?", chunks:["They","are","planning","a trip","to","Canada."], extra:"plan" },
 { id:7,  diff:"easy", context:"Where did he leave his umbrella?", chunks:["He","forgot","his","umbrella","at","the office."], extra:"forgetting" },
 { id:8,  diff:"easy", context:"Where are the children?", chunks:["The children","are","playing","in","the","garden."], extra:"play" },
 { id:9,  diff:"easy", context:"What would you like to drink?", chunks:["I","would","like","a cup","of","coffee."], extra:"liked" },
 { id:10, diff:"easy", context:"What did your teacher give you?", chunks:["Our teacher","gave","us","a lot","of","homework."], extra:"given" },
 { id:11, diff:"easy", context:"How often does the train arrive?", chunks:["The train","arrives","every","twenty","minutes."], extra:"arrive" },
 { id:12, diff:"easy", context:"What did she buy yesterday?", chunks:["She","bought","a","new","laptop","yesterday."], extra:"buys" },
 { id:13, diff:"easy", context:"How was the weather last week?", chunks:["The weather","was","very","cold","last","week."], extra:"were" },
 { id:14, diff:"easy", context:"What did you do last night?", chunks:["We","watched","an","interesting","movie","last night."], extra:"watching" },
 { id:15, diff:"easy", context:"Where do your parents live?", chunks:["My parents","live","in","a","small","village."], extra:"lives" },
 { id:16, diff:"easy", context:"When does the store open?", chunks:["The store","opens","at","nine","in","the morning."], extra:"open" },
 { id:17, diff:"easy", context:"What is he learning?", chunks:["He","is","learning","how to","play","the guitar."], extra:"learns" },
 { id:18, diff:"easy", context:"What does the museum have?", chunks:["The museum","has","many","famous","paintings."], extra:"have" },
 { id:19, diff:"easy", context:"How did they get to school?", chunks:["They","walked","to","school","in","the rain."], extra:"walking" },
 { id:20, diff:"easy", context:"What do you do after exercise?", chunks:["I","always","drink","water","after","exercise."], extra:"drinking" },
 { id:21, diff:"easy", context:"Where is the cat?", chunks:["The cat","is","sleeping","under","the","table."], extra:"sleeps" },
 { id:22, diff:"easy", context:"What happened to your flight?", chunks:["Our flight","was","delayed","by","two","hours."], extra:"delay" },
 { id:23, diff:"easy", context:"How many languages does she speak?", chunks:["She","speaks","three","different","languages."], extra:"speak" },
 { id:24, diff:"easy", context:"Until when is breakfast served?", chunks:["The restaurant","serves","breakfast","until","eleven."], extra:"serving" },
 { id:25, diff:"easy", context:"What do we need to buy?", chunks:["We","need","to","buy","some","milk."], extra:"buying" },
 { id:26, diff:"easy", context:"What did he do?", chunks:["He","sent","an","email","to","his manager."], extra:"send" },
 { id:27, diff:"easy", context:"What is the garden like?", chunks:["The garden","is","full","of","beautiful","flowers."], extra:"fully" },
 { id:28, diff:"easy", context:"What does your sister want to do?", chunks:["My sister","wants","to","become","a","doctor."], extra:"becoming" },
 { id:29, diff:"easy", context:"When does the meeting start?", chunks:["The meeting","starts","right","after","lunch."], extra:"start" },
 { id:30, diff:"easy", context:"What did they build last year?", chunks:["They","built","a","new","bridge","last year."], extra:"build" },
 { id:31, diff:"easy", context:"Where did you leave your keys?", chunks:["I","left","my","keys","on","the desk."], extra:"leave" },
 { id:32, diff:"easy", context:"What does the bakery sell?", chunks:["The bakery","sells","fresh","bread","every","morning."], extra:"sell" },
 { id:33, diff:"easy", context:"What is she reading?", chunks:["She","is","reading","a book","about","history."], extra:"reads" },
 { id:34, diff:"easy", context:"How often do you visit your grandparents?", chunks:["We","often","visit","our","grandparents."], extra:"visiting" },
 { id:35, diff:"easy", context:"Where is the phone?", chunks:["The phone","is","charging","next to","the","bed."], extra:"charges" },
 ...
 { id:37, diff:"medium", context:"What do many students struggle with?", chunks:["Many students","find","it","difficult","to manage","their time."], extra:"managing" },
 ...
 { id:39, diff:"medium", context:"When will the package be delivered?", chunks:["The package","will","be","delivered","as soon as","it is ready."], extra:"delivering" },
 { id:40, diff:"medium", context:"Why didn't she attend the meeting?", chunks:["She","couldn't","attend","the meeting","because","she was ill."], extra:"although" },
 { id:41, diff:"medium", context:"Why should we leave early?", chunks:["We","should","leave","early","to","avoid the traffic."], extra:"avoiding" },
 ...
 { id:43, diff:"medium", context:"What did he promise?", chunks:["He","promised","that","he","would","call me later."], extra:"will" },
 { id:44, diff:"medium", context:"What will happen if we don't hurry?", chunks:["Unless we hurry,","we","will","miss","the","last train."], extra:"won't" },
 { id:45, diff:"medium", context:"How was the book you borrowed?", chunks:["The book","that","I borrowed","was","surprisingly","interesting."], extra:"surprising" },
 { id:46, diff:"medium", context:"What are they looking forward to?", chunks:["They","are","looking forward","to","seeing","their friends again."], extra:"see" },
 { id:47, diff:"medium", context:"What happened while she was cooking?", chunks:["While she was cooking,","the","phone","suddenly","started","ringing."], extra:"rang" },
 { id:48, diff:"medium", context:"What has the company decided?", chunks:["The company","has","decided","to","hire","more employees."], extra:"hiring" },
 { id:49, diff:"medium", context:"Why were you surprised by the time?", chunks:["I","didn't","realize","how","late","it was."], extra:"lately" },
 ...
 { id:51, diff:"medium", context:"Did being tired stop him from working?", chunks:["Even though he was tired,","he","kept","working","until","midnight."], extra:"to work" },
 { id:52, diff:"medium", context:"When will the new policy start?", chunks:["The new policy","will","take effect","at the beginning","of","next month."], extra:"takes" },
 { id:53, diff:"medium", context:"What did she ask you?", chunks:["She","asked","me","whether","I","had finished the report."], extra:"that" },
 { id:54, diff:"medium", context:"What should you do before deciding?", chunks:["Before you make a decision,","you","should","consider","all","the options."], extra:"considering" },
 { id:55, diff:"medium", context:"Why was the bridge closed?", chunks:["The bridge","was","closed","because","it","needed repairs."], extra:"due to" },
 { id:56, diff:"medium", context:"When can we go to the beach?", chunks:["We","can't","go","to the beach","unless","the weather improves."], extra:"if" },
 { id:57, diff:"medium", context:"How hard does he work?", chunks:["He","works","so","hard","that he rarely","takes a break."], extra:"such" },
 { id:58, diff:"medium", context:"What do the results suggest?", chunks:["The results","suggest","that","the experiment","was","successful."], extra:"success" },
 { id:59, diff:"medium", context:"What happened after the storm passed?", chunks:["After the storm passed,","the city","began","to","recover","slowly."], extra:"recovering" },
 { id:60, diff:"medium", context:"What are you curious about?", chunks:["I","wonder","why","she","left","so early."], extra:"did she" },
 { id:61, diff:"medium", context:"What was the hotel like?", chunks:["The hotel","where","we stayed","had","a","wonderful view."], extra:"which" },
 { id:62, diff:"medium", context:"How long did the discussion continue?", chunks:["They","continued","the discussion","until","they reached","an agreement."], extra:"reaching" },
 { id:63, diff:"medium", context:"What happens as the population grows?", chunks:["As the population grows,","the demand","for","housing","also","increases."], extra:"increasing" },
 { id:64, diff:"medium", context:"Why did she speak clearly?", chunks:["She","spoke","clearly","so that","everyone","could hear her."], extra:"clear" },
 { id:65, diff:"medium", context:"What did the scientist discover?", chunks:["The scientist","discovered","a method","that","reduces","waste."], extra:"reducing" },
 { id:66, diff:"medium", context:"Did the difficulty stop students from passing?", chunks:["Although the test was difficult,","most students","managed","to","pass","it."], extra:"passing" },
 ...
 { id:68, diff:"medium", context:"Why couldn't you follow the instructions?", chunks:["The instructions","were","too","complicated","for me","to follow."], extra:"enough" },
 { id:69, diff:"medium", context:"What did he admit?", chunks:["He","admitted","that","he","had made","a mistake."], extra:"making" },
 { id:70, diff:"medium", context:"Why did you take a different route?", chunks:["Since the road was blocked,","we","had to","take","a","different route."], extra:"taking" },
 ...
 { id:72,  diff:"hard", context:"What would you have done about the delay?", chunks:["Had I known about the delay,","I","would","have","taken","an earlier flight."], extra:"had" },
 { id:73,  diff:"hard", context:"What did she accomplish?", chunks:["Not only","did she","finish the project,","but she also","trained","the new staff."], extra:"she did" },
 { id:74,  diff:"hard", context:"What did the researchers conclude?", chunks:["The researchers","concluded","that","the data","did not support","their hypothesis."], extra:"supporting" },
 { id:75,  diff:"hard", context:"What did you think of the presentation?", chunks:["Rarely","have","I","seen","such a well-organized","presentation."], extra:"I have" },
 ...
 { id:77,  diff:"hard", context:"How did he handle the situation?", chunks:["Despite having little experience,","he","handled","the situation","remarkably","well."], extra:"Although" },
 { id:78,  diff:"hard", context:"When can the phenomenon be understood?", chunks:["The phenomenon","can only","be understood","when","multiple factors","are considered."], extra:"understanding" },
 { id:79,  diff:"hard", context:"What surprised everyone?", chunks:["What surprised everyone","was","how","quickly","the technology","spread."], extra:"quick" },
 { id:80,  diff:"hard", context:"Is the old novel still popular?", chunks:["The novel,","written more than a century ago,","remains","widely","read","today."], extra:"writing" },
 { id:81,  diff:"hard", context:"What role did her support play?", chunks:["Were it not for her support,","the project","would","have","failed","completely."], extra:"will" },
 { id:82,  diff:"hard", context:"What do the findings imply?", chunks:["The findings","imply","that","economic growth","does not guarantee","happiness."], extra:"guaranteeing" },
 { id:83,  diff:"hard", context:"How convincing was his argument?", chunks:["So convincing","was","his argument","that","no one","dared to disagree."], extra:"such" },
 { id:84,  diff:"hard", context:"What were the students encouraged to do?", chunks:["The students","were encouraged","to","question","assumptions","they had long accepted."], extra:"questioning" },
 { id:85,  diff:"hard", context:"Does criticism stop the theory's influence?", chunks:["Although widely criticized,","the theory","continues","to","influence","modern research."], extra:"influencing" },
 { id:86,  diff:"hard", context:"What did the corporation pledge?", chunks:["The corporation","pledged","to","reduce","its emissions","over the next decade."], extra:"reducing" },
 ...
 { id:88,  diff:"hard", context:"What did the lecture do?", chunks:["The lecture","shed light on","a topic","that","had long puzzled","historians."], extra:"shedding" },
 { id:89,  diff:"hard", context:"When did the team reconsider their approach?", chunks:["Only after the experiment failed","did","the team","reconsider","their","approach."], extra:"the team did" },
 { id:90,  diff:"hard", context:"What was the result of the negotiation?", chunks:["The agreement,","reached","after months of negotiation,","satisfied","both","parties."], extra:"reaching" },
 { id:91,  diff:"hard", context:"How complex was the problem?", chunks:["Such was the complexity of the problem","that","even","experts","struggled","to solve it."], extra:"so" },
 { id:92,  diff:"hard", context:"What do the data suggest?", chunks:["The data","suggest","a correlation","that","researchers","had not anticipated."], extra:"anticipating" },
 { id:93,  diff:"hard", context:"Under what condition will the study expand?", chunks:["Provided that the funding continues,","the study","will","be","expanded","next year."], extra:"expanding" },
 { id:94,  diff:"hard", context:"What does the author argue?", chunks:["The author","argues","that","technology","has fundamentally reshaped","human relationships."], extra:"reshaping" },
 { id:95,  diff:"hard", context:"What happened soon after the meeting began?", chunks:["Hardly","had","the meeting begun","when","a serious disagreement","emerged."], extra:"than" },
 { id:96,  diff:"hard", context:"What was the effect of the new regulations?", chunks:["The new regulations,","though well-intentioned,","created","unexpected difficulties","for","businesses."], extra:"creating" },
 { id:97,  diff:"hard", context:"What did the professor emphasize?", chunks:["The professor","emphasized","that","critical thinking","cannot","be taught overnight."], extra:"taught" },
 { id:98,  diff:"hard", context:"What will happen if the proposal is accepted?", chunks:["Should the proposal be accepted,","the department","will","undergo","significant","restructuring."], extra:"would" },
 { id:99,  diff:"hard", context:"What does the evidence indicate?", chunks:["The evidence","strongly","indicates","that","the ecosystem","is recovering faster than predicted."], extra:"strong" },
 { id:100, diff:"hard", context:"What ultimately determines success?", chunks:["What ultimately determines success","is","not","talent alone","but","persistent effort."], extra:"and" }
];
